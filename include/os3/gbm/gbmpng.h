...
extern GBM_ERR png_rimgcnt(const char *fn, int fd, int *pimgcnt);
extern GBM_ERR png_rhdr(const char *fn, int fd, GBM *gbm, const char *opt);
extern GBM_ERR png_rpal(int fd, GBM *gbm, GBMRGB *gbmrgb);
extern GBM_ERR png_rdata(int fd, GBM *gbm, gbm_u8 *data);
extern GBM_ERR png_w(const char *fn, int fd, const GBM *gbm, const GBMRGB *gbmrgb, const gbm_u8 *data, const char *opt);
